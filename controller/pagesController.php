...
class PagesController extends Controller {
		...
		public function home( $day = null ){					
			...
			$d['description_for_layout'] = "We-Sport est un calendrier des activités sportives dans ta ville. Venez découvrir les associations, les amateurs, et les professionels du sport autour de chez vous ! Découvrez de nouvelles activités, pratiquez librement, et faites de nouvelles rencontres autour du sport !";
