				...
				<ul class="nav">
					...
					<li class="searchbar" id="menu-searchbar">
						...
						<form action="<?php echo Router::url('home/'.$this->cookieEventSearch->read('date'));?>" method="GET" id="formCity">
							...
							<?php echo $this->Form->_select("extend",array(0=>'+0km',10=>'+10km',30=>'+30km', 50=>'+50km',100=>'+100km'),array("default"=>$this->cookieEventSearch->read('extend'),"placeholder"=>"etendre à",'class'=>"tooltipbottom","javascript"=>'data-toggle="tooltip" title="Etendre la zone de recherche"')) ;?>															
